...
class CrossViewRocket(MinePolicy, PyTorchModelHubMixin):
    ...
    def __init__(self, 
        ...
        **kwargs,
        ...
        self.view_backbone = timm.create_model(_timm_name(view_backbone), pretrained=True, features_only=True)
        ...
        self.mask_backbone = timm.create_model(_timm_name(mask_backbone), pretrained=True, features_only=True, in_chans=1)
